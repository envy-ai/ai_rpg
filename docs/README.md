...
| [config.md](config.md)                                 | Runtime/gameplay configuration, overrides, model settings, staged tiny-brain player actions, assistant prefill, system-prompt append text, tracker limits, retry waits, global prompt concurrency, cache-stable base-context inclusion/tool schemas, shared-prefix message checkpoints, and player-action slop-context reuse, staggered prompt timing, prompt behavior, and mod enablement. |
...
| [api/game.md](api/game.md)                       | New/load/save lifecycle, CLI startup save loading, new-game runtime reset across world maps/static indexes/async work, mod mismatch handling, active calendar, config overrides, and game state endpoints. |
| [api/images.md](api/images.md)                   | Image generation, persisted entity prompts, saved-prompt regeneration, editable prompt generation, image jobs, uploads, serving, prompt batching, and weather/lighting variants.                                                                       |
...
| [slashcommands/SceneSummaryCommand.md](slashcommands/SceneSummaryCommand.md)                   | `/summarize`, `/scene_summary` exports ranges or atomically rebuilds all scene summaries and entry mappings. |
