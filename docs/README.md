...
- [api/game.md](api/game.md) — Game lifecycle endpoints (including new-game form settings save/load/list APIs); references shared payloads in `docs/api/common.md` and notes settings-sourced skills for new games.
