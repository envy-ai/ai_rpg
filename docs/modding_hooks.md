...
- `exposeToGeneratorPrompt` adds the field to the shared generated item XML scaffold. It requires `xmlPrompt.placeholder`, and `xmlPrompt.tagName` defaults to the registered field name.
