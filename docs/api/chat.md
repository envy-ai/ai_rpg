...
- Turn-end `event-summary` chat entries now append a time-passed summary item when `timeProgress.advancedMinutes > 0`, using natural duration text such as `1 minute passed.`, `4 hours and 3 minutes passed.`, or `1 day, 3 hours, and 4 minutes passed.`
