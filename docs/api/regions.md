...
- 200: `{ success: true, region, parentOptions }`
  - `region`: `{ id, name, description, parentRegionId, parentRegionName?, averageLevel, secrets }`
...
Request:
- Body: `{ name: string, description: string, parentRegionId?: string|null, averageLevel?: number|null }`
