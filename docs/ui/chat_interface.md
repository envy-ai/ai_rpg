...
- `chat_status` (spinner / progress messages; spinner stages update the non-modal `#chatSpinnerStatusBar` between the prompt-progress dock and chat input instead of opening a blocking overlay).
