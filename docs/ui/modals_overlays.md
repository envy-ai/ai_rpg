...
- `#npcEditModal`: full NPC edit form (attributes, skills, abilities, status effects).
...
- `#locationEditModal`: edit location name/description/level/status effects.
- `#regionEditModal`: edit region name/description/parent/level.
