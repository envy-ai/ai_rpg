...
test('Story Tools exposes client-side search controls', () => {
    ...
    assert.match(viewSource, /id="storyToolsTypeFilter"/);
    assert.match(viewSource, /class="story-tools-type-filter"/);
...
test('Story Tools search keeps full history and filtered result state', () => {
    ...
    assert.match(viewSource, /typeFilter:\s*''/);
    assert.match(viewSource, /typeOptions:\s*\[\]/);
    ...
    assert.match(viewSource, /refreshStoryToolsTypeFilter/);
    assert.match(viewSource, /getStoryToolsTypeFilterMatcher/);
...
test('Story Tools search has scoped styling hooks', () => {
    ...
    assert.match(scssSource, /\.story-tools-type-filter/);
